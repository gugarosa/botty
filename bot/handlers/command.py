...
def end(update, context):
    """Handles a /end command emitted by the user.
    ...
    logging.info('Current interaction ended by /end.')
    ...
    update.message.reply_text(lang['HANDLER_COMMAND_END'], reply_markup=keyboard_removal)
